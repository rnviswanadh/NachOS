...
#define MAX_ALLOWABLE_SEMOPHORES 10
#define MAX_ALLOWABLE_CONDITIONS 10
...
extern semophoreEntry semophoreTable[MAX_ALLOWABLE_SEMOPHORES];
extern conditionEntry conditionTable[MAX_ALLOWABLE_CONDITIONS];
